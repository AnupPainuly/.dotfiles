...
config.set("colors.webpage.bg","#000000") #fix for the white screen occuringg while loading new tab
c.url.start_pages = ("https://www.google.com/") #Type Fuzzy
c.url.searchengines = {'DEFAULT':'https://google.com/search?q={}'} #Type dict
